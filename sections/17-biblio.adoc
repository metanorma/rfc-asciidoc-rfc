...
Asciidoctor natively has a simple encoding of bibliographies, which is not adequate for
...
In the first method, bibliographic citations are handled like all other AsciiRFC
