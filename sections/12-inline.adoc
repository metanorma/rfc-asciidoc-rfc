...
span (e.g. `bcp14#must not#`), or by converting any boldface all-caps
words recognised as BCP14 words (unless the `:no-rfc-bold-bcp14: false` 
document attribute is set).
