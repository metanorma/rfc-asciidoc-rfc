...
-----
include::../examples/rfc-camelot-holy-grenade/draft-camelot-holy-grenade.adoc[tag=figure]
-----
--
...
[source,asciidoc]
----
include::../examples/rfc-camelot-holy-grenade/xml3/draft-camelot-holy-grenade.xml[tag=figure]
----
====
...
[source,asciidoc]
----
include::../examples/rfc-camelot-holy-grenade/draft-camelot-holy-grenade.adoc[tag=figure2]
----
====
